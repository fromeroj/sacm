const UDA_VALUE_2017 = 310.00; // Pesos mexicanos
    ...
    resultContent.innerHTML = `
        <div class="results-container">
            ...
            <div class="results-grid">
                ...
                <div class="result-card">
                    <div class="card-header">
                        <h4><i class="fas fa-calculator"></i> Cálculo SACM</h4>
                    </div>
                    <div class="card-content">
                        <div class="info-row">
                        ...
                        <div class="info-row">
                            <span class="info-label">Valor UDA :</span>
                    ...
                    <div class="card-content">
                        <div class="legal-notice">
                            <div class="notice-item">
                                ...
                                <span>Este cálculo está basado en el <strong>Tarifario SACM</strong> oficial</span>
                            </div>
                            <div class="notice-item">
                            ...
                            <div class="notice-item warning">
                                ...
                                <span>Las tarifas pueden haber cambiado. Verificar con SACM antes del pago.</span>
                            </div>
                        </div>
                    </div>
                </div>
